...
def play_with_friend(event):
    con_form = con.ConnectionForm(tk,"TKM - Multiplayer")
    tk.withdraw()
    con_form.render()

btn1 = tki.Button(tk,text = "Bilgisayar Karşı Oyna",width = "20",height = "10", fg = "white", bg = "darkblue",activebackground = "darkblue",activeforeground = "white",cursor = "hand2")
btn2 = tki.Button(tk,text = "Arkadaşınla Oyna",width = "20",height = "10",fg = "white", bg = "darkred",activebackground = "darkred",activeforeground = "white",cursor = "hand2")
