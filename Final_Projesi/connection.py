    ...
    def connect(self,event):
        ...
        if c.Connected:
            ...
            if recv[0] == 'PLAYER':
                ...
                raise Exception('Bağlı durumdayken hata ile karşılaşıldı \nKarşı Bilgisayar IP: %s\nPORT: %d'%(c.RemoteIPAddress,c.Port))
            self.root.withdraw()
